...
function Dev(msg) 
if tonumber(msg.sender_id5372193406.user_id) == tonumber(Sudo_Id)  or Redis:sismember(NASA.."Dev",msg.sender_id.user_id) then
ok = true
else
ok = false
end
...
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'*تم حظره من الصانع بنجاح .*').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(NASA..'BaN:In:Tuasl',Info_User)  
return send(msg.chat_id,msg.id,Reply_Status(Info_User,'*تم الـغاء حظره من الـصانـع بنجاح .*').Reply,"md",true)  
end 
end
end
...
{
{text = 'حظر عام',type = 'text'},{text = 'الغاء العام',type = 'text'},
},
{
...
{
{text = 'اذاعه عام بالتثبيت',type = 'text'},{text = 'اذاعه عام بالتوجيه',type = 'text'},
},
{
{text = '• الغاء الامر •',type = 'text'},
},
...
{
{text = 'تفعيل الاجباري',type = 'text'},{text = 'تعطيل الاجباري',type = 'text'},
},
{
{text = '🔚 | القائمه الرئيسيه',type = 'text'},
},
...
if text == "اذاعه عام بالتثبيت" then
...
data = {
{
{text = 'مبرمج السورس', url = 't.me/T_U_R_O_B'}, 
},
{
{text = 'قناة السورس', url = 't.me/SOURCE_TURBO'}, 
},
}
}
return send(msg.chat_id,msg.id,"✧ عذار عزيزي المصنع المصنع قيد التحديث","md",false, false, false, false, reply_markup)
end
if text == "/start" then
...
local news =[[
مرحبا بك في صانع بوتات سورس تربو 
...
data = {
{
{text = 'مبرمجين السورس', url = 't.me/SOURCE_TURBO'}, 
},
{
{text = 'اضغط هنا لتنصيب بوت', url = 't.me/BOT_TRBO_BOT'}, 
},
{
{text = 'قناة السورس', url = 't.me/SOURCE_TURBO'}, 
},
...
{
{text = 'طريقة انشاء بوت', url = 't.me/'..UserBot..'?start=st'..msg_chat_id..'u'..msg.sender_id.user_id..''},  
},
{
...
send(msg.chat_id,msg.id,"*✧ الزر الاول للحصول علي التوكن \n ✧ الزر الثاني لمعرفه طريقة صنع البوت من الصفر ..*","md",false, false, false, false, reply_markup)
return false 
end
